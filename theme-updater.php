...
Description: Checks to see if there are new version available both of the theme and core. If updates are available custom update nags are displayed instead of the standard ones.
Version: 0.4
...
define( 'THEME_UPDATER_PLUGIN_URL', get_template_directory_uri() . '/' );
	...
	<div class="wrap theme-updater">
		...
		<div class="theme">
			...
			<ul class="clearfix">
				...
				<li><?php _e( '<strong>Sikkerhed</strong><br />Udviklerne bag WordPress er dygtige og bruger lang tid p&aring; at g&oslash;re det s&aring; sikkert som overhovedet muligt, men WordPress er popul&aelig;rt og (is&aelig;r &aelig;ldre versioner) vil derfor altid v&aelig;re m&aring;l for ondsindede programm&oslash;rer, der vil fors&oslash;ge at finde en m&aring;de at f&aring; tvunget sig adgang til systemet p&aring;.<br /><em>OBS! Det er v&aelig;sentlig lettere at lukke et evt. sikkerhedshul end at skulle gennemg&aring; hele hjemmesidens kode efter en hacker har haft adgang til at &aelig;ndre den.</em>', 'theme-updater' ); ?></li>
